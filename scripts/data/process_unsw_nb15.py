#!/usr/bin/env python3
"""Strict UNSW-NB15 processing entrypoint for unified multi-dataset contract runs."""
...
def main() -> None:
    ...
    raw = loader.load_unsw()
    harmonized = loader.harmonize_unsw(raw)

    out_dir = PROJECT_ROOT / "data" / "processed"
    out_dir.mkdir(parents=True, exist_ok=True)
    out_path = out_dir / "unsw-nb15_cleaned.csv"
